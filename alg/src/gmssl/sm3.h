...
void gm_sm3_update(SM3_CTX *ctx, const uint8_t *data, size_t datalen);
void gm_sm3_finish(SM3_CTX *ctx, uint8_t dgst[SM3_DIGEST_SIZE]);
void gm_sm3_digest(const uint8_t *data, size_t datalen, uint8_t dgst[SM3_DIGEST_SIZE]);
